...
def criar_chatbot():
    ...
    prompt_do_sistema = f"""
        ...
        # HISTÓRIOCO
        Acesse sempre o histórico de mensagem, e recupere informações ditas anteriormente.
        """
...
def bot(prompt):
    ...
    while True:
        try:
            ...
            Responta a seguinte mensagem, sempre lembrando do histórico:
            {prompt}
            """

            if caminho_imagem_enviada:
                mensagem_usuario += "\n Utilize as características da imagem em sua resposta"
                arquivo_imagem = gerar_imagem_gemini(arquivo_imagem)
...
def upload_imagem():
    ...
    return "Nenhum arqivo enviado", 400
